  ...
  return (
    <section className={styles.banner}>
      <div className={styles.content}>
        ...
        <p>
          Bem-vindo ao nosso espaço dedicado à conscientização e prática da sustentabilidade!
          Aqui você encontrará informações essenciais sobre a gestão eficiente da água e as práticas de economia verde que ajudam a preservar o meio ambiente. 
